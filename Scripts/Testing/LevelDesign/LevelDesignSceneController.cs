...
namespace TankLike.Testing.LevelDesign
{
    ...
    public class LevelDesignSceneController : SceneController
    {
        [SerializeField] private LevelDesignManager _levelDesignManager;
        [SerializeField] private NormalRoom _room;
        [SerializeField] private Audio _bgMusicAudio;

        public override void SetUp()
        {
            StartCoroutine(SetupRoutine(Scenes.LEVEL_DESIGN));
        }
        ...
        protected override void SetUpManagers()
        {
            ...
            GameManager.Instance.RoomsManager.SetCurrentRoom(_room);
            ...
            GameManager.Instance.PlayersManager.GetPlayer(0).OnPlayerActivated += _levelDesignManager.SetUp;
